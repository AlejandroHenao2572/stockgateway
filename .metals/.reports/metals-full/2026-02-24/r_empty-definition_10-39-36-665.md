error id: file:///C:/Users/aleja/Downloads/stockgateway/stockgateway/src/main/java/com/stockgateway/StockService.java:_empty_/UriComponentsBuilder#fromHttpUrl#
file:///C:/Users/aleja/Downloads/stockgateway/stockgateway/src/main/java/com/stockgateway/StockService.java
empty definition using pc, found symbol in pc: _empty_/UriComponentsBuilder#fromHttpUrl#
...
public class StockService {
    ...
    public String fetch(String symbol, String type, String intradayInterval, String outputsize) {
        ...
        try {
            ...
            // Para la versión mínima devolvemos null en caso de error.
            // En una versión más completa, aquí se registraría el error y/o se devolvería una excepción controlada.
            return null;
        }
    }
}
